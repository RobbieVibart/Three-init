...
var spine = (() => {
  ...
  var THREE = __toESM(__require("three"));
  var ThreeJsTexture = class extends Texture {
    constructor(image) {
      super(image);
    ...
    static toThreeJsTextureFilter(filter) {
      if (filter === 9729 /* Linear */)
        return THREE.LinearFilter;
      else if (filter === 9987 /* MipMap */)
        return THREE.LinearMipMapLinearFilter;
      else if (filter === 9985 /* MipMapLinearNearest */)
        return THREE.LinearMipMapNearestFilter;
      else if (filter === 9986 /* MipMapNearestLinear */)
        return THREE.NearestMipMapLinearFilter;
      else if (filter === 9984 /* MipMapNearestNearest */)
        return THREE.NearestMipMapNearestFilter;
      else if (filter === 9728 /* Nearest */)
        return THREE.NearestFilter;
      else
        throw new Error("Unknown texture filter: " + filter);
    }
    static toThreeJsTextureWrap(wrap) {
      if (wrap === 33071 /* ClampToEdge */)
        return THREE.ClampToEdgeWrapping;
      else if (wrap === 33648 /* MirroredRepeat */)
        return THREE.MirroredRepeatWrapping;
      else if (wrap === 10497 /* Repeat */)
    ...
    static toThreeJsBlending(blend) {
      ...
      else if (blend === 1 /* Additive */)
        return THREE.AdditiveBlending;
      else if (blend === 2 /* Multiply */)
        return THREE.MultiplyBlending;
      else if (blend === 3 /* Screen */)
  ...
  var SkeletonMeshMaterial = class extends THREE2.ShaderMaterial {
  ...
  var _SkeletonMesh = class extends THREE2.Object3D {
    ...
    updateGeometry() {
      ...
      for (let i = 0, n = drawOrder.length; i < n; i++) {
        ...
        if (texture != null) {
          ...
          if (!batch.canBatch(
            finalVerticesLength / _SkeletonMesh.VERTEX_SIZE,
            finalIndicesLength
          )) {
            batch.end();
  ...
  var SkeletonMesh = _SkeletonMesh;
  SkeletonMesh.QUAD_TRIANGLES = [0, 1, 2, 2, 3, 0];
  SkeletonMesh.VERTEX_SIZE = 2 + 2 + 4;

  // spine-threejs/src/MeshBatcher.ts
  var THREE3 = __toESM(__require("three"));
  var _MeshBatcher = class extends THREE3.Mesh {
    constructor(maxVertices = 10920, materialCustomizer = (parameters) => {
      ...
      let geo = new THREE3.BufferGeometry();
      let vertexBuffer = this.vertexBuffer = new THREE3.InterleavedBuffer(vertices, _MeshBatcher.VERTEX_SIZE);
      ...
      geo.setIndex(new THREE3.BufferAttribute(indices, 1));
  ...
  function updateMeshMaterial(meshMaterial, slotTexture, blending) {
    ...
    meshMaterial.blendDst = blending === THREE3.CustomBlending ? THREE3.OneMinusSrcColorFactor : THREE3.OneMinusSrcAlphaFactor;
    meshMaterial.blendSrc = blending === THREE3.CustomBlending ? THREE3.OneFactor : THREE3.SrcAlphaFactor;
